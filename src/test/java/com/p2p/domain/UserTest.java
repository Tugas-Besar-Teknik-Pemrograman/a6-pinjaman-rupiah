...
class UserTest {
    ...
    void testCreateUserBorrowerValid() {
        User user = new User("Faqih1", "Faqihborrower@gmail.com", "borrower1234", 20, 1,new BigDecimal("1000000"));
    ...
    void testCreateUserLenderValid() {
        User user = new User("Faqih2", "Faqihlender@gmail.com", "Lender123", 25, 2, new BigDecimal("1500000"));
    ...
    void testUserIdGeneratedNotNull() {
        User user = new User("Faqih1", "Faqihborrower@gmail.com", "borrower1234", 20, 1, new BigDecimal("0"));
    ...
    void testUserIdLenderFormat() {
        User user = new User("Faqih2", "Faqihlender@gmail.com", "Lender123", 25, 2, new BigDecimal("0"));
        String idValue = user.getId().getValue();
    ...
    void testCreateUserBoundaryAgeExact18() {
        ...
        User user = new User("BatasUsia", "batas@gmail.com", "Pass1234", 18, 1, new BigDecimal("0"));
    ...
    void testCreateUserAgeJustBelow18() {
        ...
        Exception exception = assertThrows(IllegalArgumentException.class, () ->
                new User("BawahUsia", "bawah@gmail.com", "Pass1234", 17, 1,new BigDecimal("0"))
        );
    ...
    void testCreateUserInvalidAge() {
        Exception exception = assertThrows(IllegalArgumentException.class, () ->
                new User("Faqih", "Faqihborrower@gmail.com", "Faqihborrower123", 16, 1,new BigDecimal("0"))
        );
    ...
    void testCreateUserInvalidRole() {
        Exception exception = assertThrows(IllegalArgumentException.class, () ->
                new User("Faqih3", "faqihinvalid@gmail.com", "Pass123", 20, 4, new BigDecimal("0"))
        );
    ...
    void testCreateUserRoleZeroInvalid() {
        Exception exception = assertThrows(IllegalArgumentException.class, () ->
                new User("Faqih4", "faqihzero@gmail.com", "Pass123", 22, 0, new BigDecimal("0"))
        );
