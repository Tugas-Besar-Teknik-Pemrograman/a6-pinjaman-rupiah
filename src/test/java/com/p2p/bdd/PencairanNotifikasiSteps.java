...
public class PencairanNotifikasiSteps {
    ...
    public void loan_dengan_id_memiliki_status(String id, String status) {
        ...
        currentLoan = new Loan(loanId, borrowerId, new Money(new BigDecimal("10000000"), "IDR"));
    ...
    public void borrower_dengan_id_terdaftar_di_sistem(String id) {
        BorrowerId borrowerId = new BorrowerId(id);
    ...
    public void pencairan_untuk_loan_ditolak_karena_dana_belum_terpenuhi(String id) {
        LoanId loanId = new LoanId(id);
        when(loanRepository.findById(loanId)).thenReturn(currentLoan);
    }
    ...
    public void sistem_memproses_pencairan_untuk_loan(String id) {
        LoanId loanId = new LoanId(id);
        try {
    ...
    public void sistem_mengirimkan_notifikasi_pencairan_untuk_loan(String id) {
        LoanId loanId = new LoanId(id);
        try {
    ...
    public void status_loan_harus_berubah_menjadi(String id, String expectedStatus) {
        LoanId loanId = new LoanId(id);
    ...
    public void status_loan_tetap(String id, String expectedStatus) {
        LoanId loanId = new LoanId(id);
        Loan loan = loanRepository.findById(loanId);
        assertEquals(expectedStatus, loan.getStatus());
    }
    ...
    public void borrower_harus_menerima_notifikasi_berhasil(String id) {
        BorrowerId borrowerId = new BorrowerId(id);
    ...
    public void borrower_harus_menerima_notifikasi_gagal(String id, String alasan) {
        BorrowerId borrowerId = new BorrowerId(id);
        verify(notificationService, times(1))
